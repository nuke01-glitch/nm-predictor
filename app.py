...
if app_mode == "Public Dashboard":
    ...
    with tab4:
        ...
        st.markdown("**Project Title:** AI-Driven Predictive Modeling of Nanomaterial Properties. This platform allows researchers to evaluate high-performance nanomaterials before physical synthesis.")
